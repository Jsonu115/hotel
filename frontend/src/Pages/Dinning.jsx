...
function Dinning() {
  return (
   <>
   <Layout>
    <HeaderBanner title="DINNING" image="banner2.jpg"/>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-9 col-sm-8 col-xs-12">
                            ...
                            <p className="user-info">Posted by <a>Admin</a> in <a>General</a> | <a>10 Comments</a></p>
                            ...
                            <div className="single-bottom comment-form">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <textarea className="form-control" name="Message" placeholder="Message Here...." required=""></textarea>
